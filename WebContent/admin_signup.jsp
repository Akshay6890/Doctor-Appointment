<%@include file="adminheader.jsp" %>
	<body style="background-image:url('images/bg.png'); background-repeat:no-repeat">
		<form action="admin_signup" method="post" class="col-lg-offset-4 col-lg-4">
			<br><br><br>
			...
			<div class="col-lg-offset-4 col-lg-4"><button class="form-control" type="submit" name="signup">Signup</button><br><br></div>
		</form>
	</body>
